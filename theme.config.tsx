...
const config: DocsThemeConfig = {
  head: function useHead() {
    ...
    const title = `Code4Life | ${config.title}`;
    return (
      <>
        <title>{title}</title>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/logo/logo.svg" />
        <link rel="icon" type="image/png" sizes="16x16" href="/logo/logo.svg" />
        ...
        <div className="mx-auto max-w-[1440px] p-6 lg:py-10">
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © {new Date().getFullYear()} Code4Life.{" "}
            </span>
