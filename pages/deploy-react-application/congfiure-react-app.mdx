...
Giờ thì thực hiện build ra thành static file để cho Nginx có thể dùng để sử dụng khi có người dùng request tới
...
Khởi động lại Nginx service và kiểm tra lại status
